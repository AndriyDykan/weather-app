    ...
    <>
      {weather !== null && forcast !== null && (
        <div className="flex flex-col items-center gap-6  ">
          <section className="pb-4 flex flex-col md:flex-row items-center w-[40vw] max-w-4xl  ">
          ...
          <section className="flex flex-col py-4 gap-5 w-[40vw] max-w-4xl h-[50vh]  border-y border-grey-100">
